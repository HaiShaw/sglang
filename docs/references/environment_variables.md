...
| `SGLANG_MORI_PREALLOC_MAX_RECV_TOKENS` | Derive `SGLANG_MORI_NUM_MAX_DISPATCH_TOKENS_PER_RANK`, indicate custom amount of tokens preallocated for a rank, affecting memory consumption. Setting `0` to disable | `0` |
