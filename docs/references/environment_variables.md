...
| `SGLANG_EPLB_P2P_BATCH_CHUNK_SIZE`        | Number of logical expert IDs per batch when submitting P2P ops during EPLB rebalance on ROCm. Smaller values prevent RCCL GPU-side accumulation hangs but increase overhead. | `64`                         |
