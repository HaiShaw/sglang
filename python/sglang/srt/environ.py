...
class Envs:
    ...
    # Bounds-check every transfer entry against its registered region before
    # handing it to the backend. Off by default: the check is O(entries) per
    # layer on the send path.
