...
class DeepseekMHAForwardMixin:
    ...
    def _chunked_prefix_attn_mha(
        ...
        for i in range(forward_batch.num_prefix_chunks):
            ...
            # merge_state dispatches: merge_state_v2 on CUDA, the Triton kernel
            # elsewhere. merge_state_v2 is a CUDA-only symbol, so calling it
            # directly is what kept this loop off ROCm.
            merge_state(output, lse, accum_output, accum_lse, tmp_output, tmp_lse)
